...
export const SERVICE_PAGES: ServicePageConfig[] = [
    ...
    stackingProjects: [
      {
        ...
        col1: ['/stacking/pal-locations.jpg', '/stacking/pal-about.jpg'],
        col2: '/stacking/pal-hero.jpg',
      },
      {
        num: '02',
        name: 'Pixla AI',
        ...
        url: 'https://pixla.ai/',
        col1: ['/stacking/pixla-steps.jpg', '/stacking/pixla-gallery.jpg'],
        col2: '/stacking/pixla-hero.jpg',
      },
      {
        num: '03',
        name: 'Zesti Fusion',
        ...
        col1: ['/stacking/zesti-whoweserve.jpg', '/stacking/zesti-distributor.jpg'],
        col2: '/stacking/zesti-hero.jpg',
      },
      {
        num: '04',
        ...
        col1: ['/stacking/printx-finish.jpg', '/stacking/printx-process.jpg'],
        col2: '/stacking/printx-hero.jpg',
      },
      {
        num: '05',
        ...
        col1: ['/stacking/ardent-collab.jpg', '/stacking/ardent-family.jpg'],
        col2: '/stacking/ardent-extra.jpg',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    clientWorks: [
      ...
      { title: 'Art Lab', industry: 'Resin Art Studio', img: '/clientwork-artlab.jpg', fit: 'contain', bgColor: '#ffffff' },
      { title: 'Life Lush Health Care LLP', industry: 'Healthcare', img: '/clientwork-llhc.jpg' },
      { title: 'Plan Nest', industry: 'Architecture & Interior', img: '/clientwork-plannest.jpg' },
      { title: "Happy'ness Reloaded", industry: 'Restaurant & F&B', img: '/clientwork-happyness.jpg' },
      { title: 'The Osin Studio', industry: 'Resin Art Studio', img: '/clientwork-osinstudio.png', fit: 'contain', bgColor: '#f6f2cf' },
      { title: 'Beyond Bajji', industry: 'Food & Beverage', img: '/clientwork-beyondbajji.jpg' },
      ...
      { title: 'KKR Developers', industry: 'Real Estate & Construction', img: '/clientwork-kkrdevelopers.jpg' },
      { title: 'Tinted - The Nail Studio', industry: 'Beauty & Nail Salon', img: '/clientwork-tinted.png', fit: 'contain', bgColor: '#ffffff' },
      { title: 'Healthigo', industry: 'Health & Wellness', img: '/clientwork-healthigo.jpg' },
    ],
  },
  {
    ...
    clientWorks: [
      ...
      { img: '/social/beyondbajji-why-us.jpg', title: 'Why Beyond Bajji', industry: 'Beyond Bajji' },
      ...
      { img: '/social/beyondbajji-mirchi-bajji.jpg', title: 'New Trend: Mirchi Bajji', industry: 'Beyond Bajji' },
      ...
      { img: '/social/beyondbajji-just-fried.jpg', title: 'Food Is Just Fried', industry: 'Beyond Bajji' },
      ...
      { img: '/social/beyondbajji-fried-icecream.jpg', title: 'Fried Ice Cream', industry: 'Beyond Bajji' },
    ...
    featuredWorks: [
      {
        ...
        images: [
          { src: '/casestudy-pal-madhapur.jpg', label: 'Madhapur - "best physiotherapist in Madhapur"' },
          { src: '/casestudy-pal-kondapur.jpg', label: 'Kondapur - "best sports rehab in Kondapur"' },
        ],
      ...
      },
      {
        ...
        images: [
          { src: '/casestudy-squaredesigns-search.jpg', label: 'Search Ranking - "printing shop in madhapur"' },
          { src: '/casestudy-squaredesigns-performance.jpg', label: 'Business Profile Performance - Last 30 Days' },
        ],
      ...
      },
      {
        ...
        images: [
          { src: '/casestudy-printx-search.jpg', label: 'Search Ranking - "flex design & print gachibowli"' },
          { src: '/casestudy-printx-performance.jpg', label: 'Business Profile Performance - Direction Requests' },
        ],
      ...
      },
      {
        ...
        images: [{ src: '/casestudy-evania-search.jpg', label: 'Search Ranking - "evania"' }],
  ...
  },
  {
    ...
    clientWorks: [
      { title: 'Apple Cider Vinegar Gummies', industry: 'Ayur Gum - Supplements', img: '/clientwork-ayurgum-acv-gummies.jpg' },
      { title: 'Caramel Fox Nuts', industry: "Oh So Poppin' - Snacks", img: '/clientwork-ohsopoppin-caramel.jpg' },
      { title: 'Gift Box - Teal & Marigold', industry: 'Sahadeva Reddy - Sweets & Snacks', img: '/clientwork-sahadevareddy-box-teal.jpg' },
      ...
      { title: 'Sweet Tubs - Junnu', industry: 'Sahadeva Reddy - Sweets & Snacks', img: '/clientwork-sahadevareddy-tubs.jpg' },
      ...
      { title: 'Gift Box - Royal Purple', industry: 'Sahadeva Reddy - Sweets & Snacks', img: '/clientwork-sahadevareddy-box-purple.jpg' },
      { title: 'Vitamin K2 + D3', industry: 'Ayur Gum - Supplements', img: '/clientwork-ayurgum-vitamink2d3.jpg' },
      { title: 'Cream & Onion Fox Nuts', industry: "Oh So Poppin' - Snacks", img: '/clientwork-ohsopoppin-creamonion.jpg' },
      { title: 'Snack Pouches', industry: 'Sahadeva Reddy - Sweets & Snacks', img: '/clientwork-sahadevareddy-pouches.jpg' },
      { title: 'Honey Splash', industry: 'Nature Keen - Honey', img: '/clientwork-naturekeen-honey-splash.jpg' },
      { title: 'African Mango Drops', industry: 'Ayur Gum - Supplements', img: '/clientwork-ayurgum-mangodrops.jpg' },
      { title: 'Gift Box - Floral Sage', industry: 'Sahadeva Reddy - Sweets & Snacks', img: '/clientwork-sahadevareddy-box-floral.jpg' },
      { title: 'Himalayan Salt Fox Nuts', industry: "Oh So Poppin' - Snacks", img: '/clientwork-ohsopoppin-himalayansalt.jpg' },
      { title: 'Pre-Workout Watermelon', industry: 'Ayur Gum - Supplements', img: '/clientwork-ayurgum-preworkout.jpg' },
      { title: 'Salt & Pepper Fox Nuts', industry: "Oh So Poppin' - Snacks", img: '/clientwork-ohsopoppin-saltpepper.jpg' },
      { title: 'Whey Isolate Protein', industry: 'Ayur Gum - Supplements', img: '/clientwork-ayurgum-wheyprotein.jpg' },
      { title: 'Collagen Peptides - Label Detail', industry: 'Supplements', img: '/clientwork-collagen-peptides.jpg' },
    ],
    marqueeImages: [
  ...
  },
  {
    ...
    clientWorks: [
      ...
      { title: 'Employee ID Card', industry: 'Anatta IT Solutions', img: '/clientwork-anatta-idcard.jpg', fit: 'contain', bgColor: '#2438a8' },
