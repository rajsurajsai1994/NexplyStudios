...
import { EVENT_GRADIENT, eventGradientText } from '../../lib/eventManagement';
  ...
  return (
    <section ref={ref} className="relative overflow-hidden" style={{ background: DARK_BG_GRADIENT }}>
      ...
      <div
        ...
        style={{ maxWidth: 1080, padding: 'clamp(150px, 18vw, 220px) clamp(16px, 4vw, 40px) clamp(80px, 10vw, 130px)' }}
      >
        <FadeIn y={18}>
          <h1
        ...
        <FadeIn y={16} delay={0.1}>
          <p
            ...
            style={{ color: 'rgb(206, 197, 224)', fontSize: 'clamp(15px, 1.2vw, 18px)', lineHeight: 1.7, maxWidth: 860 }}
          >
